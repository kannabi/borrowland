...
//Я не смог найти достаточно адекватного способа добраться до ресурсов в asynctask,
// так что адрес сервера передается в качестве первого параметра

public abstract class RegisterUser extends AsyncTask<String, Void, List> implements CallbackReceiver  {

    final private String GOOD_RESPONSE = "\"OK\"";
    final private String METHOD = "addUser";
